...
import { Heart, MapPin, BedDouble, Bath, Maximize, Phone, MessageCircle } from "lucide-react";
      ...
      <div className="p-5">
        ...
        <div className="flex items-end justify-between">
          ...
          <div className="flex items-center gap-2">
            <a
              href="tel:01020010906"
              aria-label={t("quickContact.call")}
              title={t("quickContact.call")}
              onClick={(e) => e.stopPropagation()}
              className="h-9 w-9 rounded-full bg-secondary text-secondary-foreground flex items-center justify-center shadow-soft hover:scale-110 transition-transform"
            >
              <Phone className="h-4 w-4" />
            </a>
            <a
              href="https://wa.me/2001155405831"
              target="_blank"
              rel="noopener noreferrer"
              aria-label={t("quickContact.whatsapp")}
              title={t("quickContact.whatsapp")}
              onClick={(e) => e.stopPropagation()}
              className="h-9 w-9 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-soft hover:scale-110 transition-transform"
            >
